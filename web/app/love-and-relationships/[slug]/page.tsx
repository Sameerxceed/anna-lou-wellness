...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${title} — Love \& Relationships`,
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .sub-kicker { font-family:Mulish,sans-serif; font-weight:500; font-size:0.65rem; letter-spacing:0.18em; text-transform:uppercase; color:#F280AA; margin-bottom:0.5rem; text-align:center; }
        ...
        .sub-back { font-family:Mulish,sans-serif; font-weight:400; font-size:0.65rem; letter-spacing:0.14em; text-transform:uppercase; color:#F280AA; border-bottom:1px solid #F280AA; padding-bottom:2px; text-decoration:none; display:inline-flex; align-items:center; gap:0.4rem; }
        @media (max-width:900px) { .sub-page { padding:1.5rem 1.2rem 2rem; } }
      ` }} />
      <article className="sub-page">
        <div className="sub-inner">
          <p className="sub-kicker">Love \& Relationships</p>
          ...
          <Link href="/love-and-relationships" className="sub-back">&larr; Back to Love \& Relationships</Link>
        </div>
      </article>
    </>
  );
