...
export const siteSettings: SiteSettings = {
  ...
  phone: "07738 470156",
  address: "Half Mile, Taggs Island, Hampton TW12 2HA",
  mapLatitude: 51.4500,
  mapLongitude: -0.3300,
...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Signal Collective · Mastermind", href: "/the-work/signal-collective" },
      { label: "1:1 Reset Sessions", href: "/the-work/sessions" },
      { label: "Recovery Coaching", href: "/the-work/recovery" },
