    ...
    <>
        ...
        <section className="feed-featured">
          <div className="feed-featured-inner">
            ...
            <div className="reveal rd1">
              ...
              <Link href={`${sectionHref}/${articles[0].slug}`} className="feed-read-link" style={{ color: accentForText(kickerColour) }}>
      ...
      {articles.length === 0 && (
        <section className="feed-empty">
          ...
          <Link href="/reset-letters" className="feed-empty-cta" style={{ color: accentForText(kickerColour), borderColor: kickerColour }}>
...
.feed-breadcrumb { font-family:Mulish,sans-serif; font-weight:500; font-size:0.62rem; letter-spacing:0.18em; text-transform:uppercase; color:#5D5A52; margin-bottom:0.9rem; display:inline-flex; align-items:center; gap:0.5rem; }
.feed-breadcrumb-parent { color:#5D5A52; text-decoration:none; transition:color 0.2s; }
...
.feed-filter { font-family:Mulish,sans-serif; font-weight:400; font-size:0.65rem; letter-spacing:0.08em; text-transform:uppercase; color:#5D5A52; text-decoration:none; padding-bottom:3px; border-bottom:2px solid transparent; transition:all 0.3s; white-space:nowrap; flex-shrink:0; }
...
.feed-featured-date { font-family:Mulish,sans-serif; font-size:0.72rem; color:#5D5A52; letter-spacing:0.05em; margin-bottom:0.8rem; }
...
.feed-card-date { font-family:Mulish,sans-serif; font-size:0.6rem; color:#5D5A52; }
