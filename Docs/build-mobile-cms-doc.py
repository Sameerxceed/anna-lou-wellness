...
lede(d, "What changed this week — and how to use it. Anna Lou Wellness · 9 June 2026")
...
# ── Section 3: Quick Photos ──
divider(d)
kicker(d, "Quick Photos")
h2(d, "Every hero image in your site, one tap to replace.")
para(d, "New sidebar item in the CMS: Quick Photos (📷 icon).")
para(d, "Opens a single page showing every hero, portrait, and featured photo across your entire site as thumbnails. Homepage hero, every programme hero, every practitioner portrait, every Page Builder page hero — all in one grid.")
h3(d, "How to swap a photo")
step(d, 1, "Open CMS → Quick Photos (sidebar)")
step(d, 2, "Find the thumbnail you want to replace")
step(d, 3, "Tap Replace (or Upload if it's empty)")
step(d, 4, "Pick a photo from your phone")
step(d, 5, "The thumbnail updates. Tap the entry name → tap Publish to push live.")
para(d, "Total: ~4 taps. Old way was ~10.")
...
step(d, 3, "CMS → Quick Photos → Homepage hero → Replace → pick the photo")
step(d, 4, "Tap entry name → Publish")
step(d, 5, "View live page → pull to refresh → confirm it looks right")
para(d, "Total time: about 30 seconds. The old workflow took 2–3 minutes and several full navigation cycles.")
...
tick(d, "Draft mode + View Live button + Quick Photos + iOS Shortcut all wired and live.")
para(d, "")
