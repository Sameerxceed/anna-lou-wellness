...
Five sidebar items make life faster — use them often:
...
- **Help · Ask** — a chat box that answers any question about how to use the CMS by reading this manual for you. Type a question like "how do I add a cover image to a service?" or "why is my change not showing?" and it gives you the answer, the exact click path, and the section number to look up.
...
### 16.10a Finding a Category in the Article picker (tip)

When you edit an Article, the **Category** dropdown shows every editorial category across all 4 sections (Reset Stories, Life, Love & Relationships, Work & Money) in one list. There are 18 in total so they don't all fit on screen at once.

**Fastest way to pick one:**
- Click the **Category** dropdown.
- **Start typing** the category name — e.g. type "found" and "Founder Reset" filters to the top.
- Tap to select.
...
### 17.18 Help Â· Ask â€” chat your manual

Two ways to open it:
- **Floating "Ask" button** in the bottom-right corner of every CMS page (mobile and desktop). Tap it from anywhere â€” a chat panel slides open.
- **Help Â· Ask** in the left sidebar â€” full-page version if you prefer a wider chat area.

It reads this whole manual and answers any question you have about the CMS.

Examples that work well:
- "How do I add a cover image to a service?"
- "How do I publish a draft article?"
- "Why is my change not showing on the website?"
- "How do I upload many photos at once?"
- "Where do I change the homepage hero?"

Every answer cites the section number from this manual (e.g. "See Â§16.7 Programme pages") so you can scroll the source if you want more context. If the manual doesnâ€™t cover something, it will say so and tell you to WhatsApp Sameer â€” it never makes up CMS paths.
