...
async function seedPages(strapi) {
  ...
  await ensureSingleType(strapi, 'api::homepage.homepage', {
    ...
    heroBody: "Honest stories, real practices, and a life beautifully lived — for women coming back to themselves.",
    ...
    workBody1: "This work meets you in the body, where the patterns actually live. The Signal Method™ is the umbrella — programmes underneath for each stage of the journey.",
    workBody2: "",
    ...
    shopBody: "Twenty-five years of jewellery design. The pieces that matter are the ones you reach for in hard moments — the ones that remind you.",
  ...
  await ensure(strapi, 'api::generic-page.generic-page', 'the-work-ways-to-work-with-me', {
    ...
    ctaLabel: 'Book a 15-minute 1 to 1 chat',
    ctaUrl: '/contact',
  });
  ...
  await ensure(strapi, 'api::programme.programme', 'signal-collective', {
    ...
    pricingLabel: 'Investment',
    pricingBody: 'By enquiry. Application form first, then a 1 to 1 chat.',
    ctaLabel: 'Apply',
    ctaUrl: '#apply',
    pricePence: 0,
    currency: 'gbp',
